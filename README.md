...
```
git clone https://github.com/SergeyG-Solicy/Text-Video.git
```
...
To work on remotion codes and check the state in browser
...
### `npm run remotion` or `yarn run remotion`

Runs the remotion studio.\
Open [http://localhost:3000/runner](http://localhost:3000/runner) to view it in the browser.

### `npm run render` or `yarn run render`

Will render and download mp4 file in out folder
